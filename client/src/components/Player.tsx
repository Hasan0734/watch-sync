...
const Player = ({targetRoomId, socket}: PlayerProps) => {
    ...
    const handlePlay = () => {
        ...
        const msg = {
            clientId,
            username,
            text: `Play the video at ${playerRef.current?.currentTime}`,
            createdAt: new Date(),
        }
        socket?.emit("player:play", msg)
    };
    ...
    const handlePause = () => {
        ...
        const msg = {
            clientId,
            username,
            text: `Pause the video at ${playerRef.current?.currentTime}`,
            createdAt: new Date(),
        }
        socket?.emit("player:pause", msg);
